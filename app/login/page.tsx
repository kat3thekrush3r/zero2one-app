  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ backgroundColor: "#0a0e1a" }}>
      <div className="w-full max-w-md">
        ...
        {/* Login Card - Updated to glassmorphic dark card with subtle border */}
        <Card
        ...
        >
          ...
          <CardContent className="space-y-5" style={{ padding: "0 3rem 3rem 3rem" }}>
            <Button className="w-full h-12 bg-white hover:bg-gray-100 text-gray-900 font-semibold transition-all flex items-center justify-center gap-3">
            ...
            <div className="text-center pt-4 border-t" style={{ borderColor: "rgba(255, 255, 255, 0.1)" }}>
              <p className="text-sm" style={{ color: "rgba(255, 255, 255, 0.4)" }}>
                ...
                <a href="#" className="hover:underline transition-colors" style={{ color: "#7FFF7F" }}>
                  Contact us
                </a>
              </p>
            </div>
